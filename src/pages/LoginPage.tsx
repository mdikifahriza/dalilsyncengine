...
export default function LoginPage({ onNavigateToRegister, onNavigateToUsage }: LoginPageProps) {
          ...
          >
            ...
            >
              <Button
                ...
                className="w-full flex items-center justify-center py-3 border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50"
              >
