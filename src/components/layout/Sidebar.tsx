// src/components/layout/Sidebar.tsx - UPDATED: Logout button scrollable
...
export default function Sidebar({
  ...
  return (
    <aside
      ...
      `}
    >
      {/* School Identity - Clickable */}
      <div
        onClick={() => {
          onNavigate('school-settings');
          if (window.innerWidth < 768) onToggle();
        }}
        className="px-6 py-5 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition flex-shrink-0"
      >
      ...
      {/* Navigation - Scrollable with padding bottom for mobile */}
      <nav className="flex-1 px-4 py-6 space-y-6 overflow-y-auto pb-24 md:pb-6">
        ...
        <div className="pt-4 pb-4">
          <motion.button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg
                       text-red-600 hover:bg-red-50 transition-colors border border-red-200"
          >
